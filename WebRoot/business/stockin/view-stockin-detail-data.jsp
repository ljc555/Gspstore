             ...
             <div id="printDiv">
                <table id="datatable"   border="1"  style="font-size:12px;border-collapse: collapse;width:1400px;">
                        <tr class="trHeader">
							  ...
							  <td style="text-align: center;width:70px;">仓库</td>
							  <td style="text-align: center;width:110px;">品名</td>
							  ...
							  <td style="text-align: center;width:80px;">入库数量</td>
							  <td style="text-align: center;width:90px;">入库金额</td>
							  <td style="text-align: center;width:80px;">退货数量</td>
