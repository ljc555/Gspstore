             ...
             <div id="printDiv">
                <table id="datatable"   border="1"  style="font-size:12px;border-collapse: collapse;width:100%;">
                        <tr class="trHeader">
							  ...
							  <td style="text-align: center;width:220px;">供货商名称</td>
							  <td style="text-align: center;width:120px;">入库单号</td>
							  <td style="text-align: center;width:150px;">入库日期</td>
							  <td style="text-align: center;width:100px;">仓库</td>
							  <td style="text-align: center;width:100px;">操作人</td>
							  <td style="text-align: center;width:180px;">入库金额</td>
                        ...
                        <s:if test="viewStockinTotalList.size >0">
                        <s:iterator value="viewStockinTotalList" var="poMap" status="stuts">
                          ...
                          <s:set id="totalamountback" value="#totalamountback+#poMap.backamount"></s:set>
	                        ...
	                        <s:if test="#stuts.index==viewStockinTotalList.size-1">
	                            <tr>
	                               <td colspan="6"></td>
		                           <td  style="text-align:right;font-weight:bold;">入库小计:&nbsp;&nbsp;<s:property value="#smallamount" /></td>
		                           <td  style="text-align:right;font-weight:bold;">退货小计:&nbsp;&nbsp;<s:property value="#smallamountback" /></td>
                         ...
                         <tr>
		                      <td colspan="8" style="text-align:left;font-weight:bold;">净入库金额:&nbsp;&nbsp;<s:property value="#totalamount - #totalamountback" /></td>
		                 </tr> 
                      	</s:if>  
                       </tbody>
                      </table>
