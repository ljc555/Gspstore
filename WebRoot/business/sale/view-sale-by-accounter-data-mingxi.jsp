...
<body style="margin: 0px;padding:5px;vertical-align: top;">
        <div style="width:99%;text-align:center;">
             ...
             <div id="printDiv">
                <table id="datatable"   border="1"  style="font-size:12px;border-collapse: collapse;width:2000px;">
                        <tr class="trHeader">
							  ...
							  <td style="text-align: center;width:60px;">客户名称</td>
							  ...
							  <td style="text-align: center;width:90px;">提成比例</td>
							  <td style="text-align: center;width:90px;">提成金额</td>
                        </tr>
                        ...
                        <s:set id="smallrateamount" name="smallrateamount" value="0"></s:set>
                        <s:set id="rateamount" name="rateamount" value="0"></s:set>
                        <s:set id="p_accountid" name="p_accountid" value=""></s:set>
                        <s:set id="c_accountid" name="c_accountid" value=""></s:set>
                        <s:if test="viewSaleByAccounterList.size >0">
                        <s:iterator value="viewSaleByAccounterList" var="poMap" status="stuts">
                          <s:set id="c_accountid" value="#poMap.accountid"></s:set>
                          <s:if test="#stuts.index!=0&&#p_accountid!=#c_accountid">
                               <tr>
                                   <td colspan="12"></td>
		                           ...
		                           <td style="text-align:right;font-weight:bold;">
		                                      提成小计:&nbsp;&nbsp;<s:property value="#smallrateamount" />
		                           </td>
		                       </tr> 
		                       ...
		                       <s:set id="smallrateamount" value="0"></s:set>
                          </s:if>
                          ...
                          <s:set id="smallrateamount" value="#smallrateamount+#poMap.rateamount"></s:set>
                          <s:set id="rateamount" value="#rateamount+#poMap.rateamount"></s:set>
	                        <tr class="trTBody">
							  ...
							  <td align="right" > ${poMap.salerate }</td>
							  <td align="right" > ${poMap.rateamount }</td>
	                        </tr>
	                        <s:if test="#stuts.index==viewSaleByAccounterList.size-1">
	                            <tr>
	                              <td colspan="12"></td>
		                           <td style="text-align:right;font-weight:bold;">销售小计:<s:property value="#smallnum" /></td>
		                           <td  style="text-align:right;font-weight:bold;">销售小计:&nbsp;&nbsp;<s:property value="#smallamount" /></td>
	                        ...
	                        <s:set id="p_accountid" value="#c_accountid"></s:set>
                        </s:iterator>
                         <tr>
                              <td colspan="12"></td>
		                      <td style="text-align:right;font-weight:bold;">销售总计:<s:property value="#totalnum" /></td>
		                      ...
		                      <td style="text-align:right;font-weight:bold;">退货总计:<s:property value="#totalnumback" /></td>
		                      <td style="text-align:right;font-weight:bold;">退货总计:&nbsp;&nbsp;<s:property value="#totalamountback" /></td>
		                      <td></td>
		                      <td style="text-align:right;font-weight:bold;">
		                                      提成总计:&nbsp;&nbsp;<s:property value="#rateamount" />
		                      </td>
		                 </tr> 
                         <tr>
		                      <td colspan="20" style="text-align:left;font-weight:bold;">
		                       ...
		                       &nbsp;&nbsp;&nbsp;&nbsp; 提成总金额:&nbsp;&nbsp;<s:property value="#rateamount" />
		                      </td>
		                 </tr> 
                      	</s:if>  
                       </tbody>
