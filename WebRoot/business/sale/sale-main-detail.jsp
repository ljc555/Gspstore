...
function printSaleBill(){
	...
	print_top = 15;
	LODOP.ADD_PRINT_TEXT(print_top,3,291,32,"${companyPage.companyname }销售出库单");
...
function printTopSecond(){
    ...
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,230,130,print_row_height,"");
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,230,200,print_row_height,"制单日期："+getFormatValue("TIME:yyyy-mm-dd hh:mm",$("#createdate").val()));
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,580,120,print_row_height,"");
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,530,190,print_row_height,"合计金额(小写)："+$("#amount").val()+"(元)");
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
}
function printBottomAmount(){
    ...
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(270,300,300,print_row_height,"本页金额(大写)："+getFormatValue("UpperMoney",page_small_amount));
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
...
function printAddHead(){
   ...
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
   LODOP.ADD_PRINT_TEXT(print_top,245,60,print_row_height,"销售数量");
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
   ...
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
    LODOP.ADD_PRINT_TEXT(print_top,415,50,print_row_height,"销售价");
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
                ...
                <table width="997">
                  <tr bgcolor="#CCE6D1">
					...
					<tr>
                    	...
                    	<td align="left">
                    		<input id="createdate" name="createdate" type="text" class="easyui-validatebox" maxlength="" value="${salePage.createdate }" data-options="required:true"/>
                    	</td>
                    ...
                    <table border="0" cellpadding="2" cellspacing="0" id="saleDetail_table">
                        ...
                        <s:iterator value="saleDetailList" var="poVal" status="stuts">
	                        <tr>
								  ...
								  <input name="saleDetailList[${stuts.index }].secretno" maxlength="50" type="text" value="${poVal.secretno }" class="easyui-validatebox" style="width:80px;" ></td>
	                        </tr>
                        </s:iterator>
                      	</s:if>  
                       </tbody>
