...
function printSaleBill(){
	...
	var $tbody = $("#add_saleDetail_table");
	...
	print_top = 15;
	LODOP.ADD_PRINT_TEXT(print_top,3,291,32,"长沙泰正医药科技有限公司销售出库单");
	...
	LODOP.SET_PRINT_PAGESIZE(1,2540,930,"");
	LODOP.PREVIEW();
}
function printTop(){
    print_top =print_top + 25;
    LODOP.ADD_PRINT_TEXT(print_top,15,240,print_row_height,"客户名称："+$("#customername").val());
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,243,130,print_row_height,"业务员："+$("#accountname").val());
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,370,230,print_row_height,"销售单号："+$("#salebillno").val());
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,560,320,print_row_height,"");
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
...
function printTopSecond(){
    print_top =print_top + 25;
    LODOP.ADD_PRINT_TEXT(print_top,15,260,print_row_height,"打印日期："+getFormatValue("TIME:yyyy-mm-dd hh:mm:ss",new Date().toLocaleString()));
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
...
function printBottomAmount(){
    LODOP.ADD_PRINT_TEXT(315,20,340,print_row_height,"本页小计金额(大写)："+getFormatValue("UpperMoney",page_small_amount));
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(315,540,340,print_row_height,"合计金额(大写)："+getFormatValue("UpperMoney",$("#amount").val()));
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",3);
}
function printAddHead(){
   print_top = print_top + 25;
   LODOP.ADD_PRINT_TEXT(print_top,15,140,print_row_height,"品种名称");
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
   ...
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
   LODOP.ADD_PRINT_TEXT(print_top,613,70,print_row_height,"销售价");
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
   LODOP.ADD_PRINT_TEXT(print_top,683,80,print_row_height,"销售数量");
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
...
function printAddRow(row){
   ...
   LODOP.ADD_PRINT_TEXT(print_top,15,140,print_row_height,row.find("input[name*='.articlename']").eq(0).val());
   LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
   LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
        ...
        <div id="chk_idAll">
            <form name="myForm" id="myForm" method="post">
              <div>
                <table width="997">
                  <tr bgcolor="#CCE6D1">
                    <td colspan="8"  align="center" style="font-size:14px;"><strong>销售单详情</strong></td>
                    <input type="hidden" name="salebillno" value="${salePage.salebillno }"/>
                  </tr>
					<tr>
                   	 	<td align="left">操作人</td>
                    	<td align="left">
                    	    <input name="" class="easyui-validatebox" type="text" value="${salePage.crtusername }"    />
                    	</td>
                   	 	<td align="left">销售客户</td>
                    	<td align="left">
                    		<input id="customername" name="customername" type="text" class="easyui-validatebox" maxlength="20" value="${salePage.customerpage.customername }" data-options="required:true"/>
                    	</td>
                   	 	<td align="left">销售日期</td>
                    	<td align="left">
                    		<input id="saledate" name="saledate" type="text" class="easyui-validatebox" maxlength="" value="${salePage.saledate }" data-options="required:true"/>
                    	</td>
                   	 	<td align="left">业务员</td>
                    	<td align="left">
                    		<input id="accountname" name="accountname" type="text" class="easyui-validatebox" maxlength="20" value="${salePage.accounterpage.accountname }" data-options="required:true"/>
                    	</td>
					</tr>
					<tr>
                    	...
                    	<td align="left">
                    		<input id="crtusername" name="crtusername" type="text" class="easyui-validatebox" maxlength="50" value="${salePage.crtusername }" data-options="required:true"/>
                    	</td>
                    	<td align="left">销售金额</td>
                    	<td align="left">
                    		<input id="amount" name="amount" type="text" class="easyui-validatebox" maxlength="100" value="${salePage.amount }" data-options=""/>
                    	</td>
					</tr>
					<tr>
                   	 	<td align="left">销售单号</td>
                    	<td align="left">
                    		<input id="salebillno" name="salebillno" type="text" class="easyui-validatebox" maxlength="" value="${salePage.salebillno }" data-options="required:true"/>
                    	</td>
                   	 	<td align="left">创建日期</td>
                    	<td align="left">
                    		<input name="createdate" type="text" class="easyui-validatebox" maxlength="" value="${salePage.createdate }" data-options="required:true"/>
                    	</td>
                    ...
                    <table border="0" cellpadding="2" cellspacing="0" id="saleDetail_table">
                        ...
                        <s:iterator value="saleDetailList" var="poVal" status="stuts">
	                        <tr>
								  ...
								  <td align="left"><input name="saleDetailList[${stuts.index }].articlename" maxlength="20" type="text" value="${poVal.articlepage.articlename }" class="easyui-validatebox" style="width:130px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].articlespec" maxlength="20" type="text" value="${poVal.articlepage.articlespec }" class="easyui-validatebox" style="width:50px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].unitname" maxlength="20" type="text" value="${poVal.articlepage.unitdic.paramName }" class="easyui-validatebox" style="width:40px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].factory" maxlength="20" type="text" value="${poVal.articlepage.factory }" class="easyui-validatebox" style="width:80px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].depotname" maxlength="20" type="text" value="${poVal.depotpage.depotname }" class="easyui-validatebox" style="width:60px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].serial" maxlength="20" type="text" value="${poVal.serial }" class="easyui-validatebox" style="width:70px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].expiredate" maxlength="20" type="text" value="${poVal.expiredate }" class="easyui-validatebox" style="width:70px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].retailprice" maxlength="" type="text" value="${poVal.articlepage.retailprice }" class="easyui-validatebox" style="width:60px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].saleprice" maxlength="" type="text" value="${poVal.saleprice }" class="easyui-validatebox" style="width:60px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].num" maxlength="" type="text" value="${poVal.num }" class="easyui-validatebox" style="width:70px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].amount" maxlength="" type="text" value="${poVal.amount }" class="easyui-validatebox" style="width:70px;" ></td>
								  <td align="left"><input name="saleDetailList[${stuts.index }].secretno" maxlength="50" type="text" value="${poVal.secretno }" class="easyui-validatebox" style="width:80px;" ></td>
	                        </tr>
                        </s:iterator>
                      	</s:if>  
                       </tbody>
