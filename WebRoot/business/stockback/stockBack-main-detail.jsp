...
function printSaleBill(){
	...
	print_top = 15;
	LODOP.ADD_PRINT_TEXT(print_top,3,291,32,"${companyPage.companyname }采购退货单");
...
function printTop(){
    ...
    LODOP.ADD_PRINT_TEXT(print_top,243,130,print_row_height,"退货仓库："+$("#depotname").val());
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,370,230,print_row_height,"原出库单号："+$("#stockbackno").val());
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,560,320,print_row_height,"退货单号："+$("#stockbackno").val());
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
...
function printTopSecond(){
    ...
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,200,10,print_row_height,"");
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    ...
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(print_top,580,220,print_row_height,"合计金额(小写)：-"+$("#amount").val()+"(元)");
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
}
...
function printBottomAmount(){
    ...
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
    LODOP.ADD_PRINT_TEXT(65,390,200,print_row_height,"本页小计(小写):-"+page_small_amount+"(元)");
    LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
    LODOP.SET_PRINT_STYLEA(0,"Alignment",1);
}
        ...
        <div id="chk_idAll" >
            <form name="myForm" id="myForm" method="post">
              <div >
                <table width="950px;">
                  <tr bgcolor="#CCE6D1">
                    <td colspan="8"  align="center" style="font-size:14px;"><strong>采购退货单详情</strong></td>
                  </tr>
					<tr>
					    <td align="left">供应商</td>
                    	<td align="left">
                    	     <input type="hidden" id="stockbackno" name="stockbackno" value="${stockBackPage.stockbackno }" />
                    	     <input type="text" id="suppliername" value="${stockBackPage.supplierpage.suppliername }"   style="width: 159px;" />
                    	</td>
                    	<td align="left">仓库</td>
                    	<td align="left">
                    	    <input type="text" id="depotname" value="${stockBackPage.depotpage.depotname }"   style="width: 159px;" />
                    	</td>
                   	 	<td align="left">退货日期</td>
                    	<td align="left">
                    		<input type="text" id="createdate"  value="${stockBackPage.createdate }" data-options="required:true" style="width:150px;"/>
                    	</td>
                   	 	<td align="left">退货金额</td>
                    	<td align="left">
                    		<input type="text" id="amount" value="${stockBackPage.amount }" data-options="required:true" style="width:150px;"/>
                    	</td>
					</tr>
					<tr>
					    <td align="left">操作人姓名</td>
                    	<td align="left">
                    		<input id="crtusername" name="crtusername" type="text" class="easyui-validatebox" maxlength="50" value="${stockBackPage.crtusername }" data-options=""/>
                    	</td>
                    	<td align="left">创建日期</td>
                    	<td align="left">
                    		<input name="createdate" id="createdate" readonly="readonly" type="text"  maxlength="" value="${stockBackPage.createdate }" data-options="required:true" style="width:150px;"/>
                    	</td>
                    	<td align="left">退货单号</td>
                    	<td align="left">
                    	    <input id="stockbackno" name="stockbackno" readonly="readonly" type="text"  maxlength="" class="easyui-validatebox" value="${stockBackPage.stockbackno }" data-options=""/>
                    	</td>
                    	<td align="left">原出库单号</td>
                    	<td align="left">
                    	    <input id="stockinbillno" name="stockinbillno" readonly="readonly" type="text"  maxlength="" class="easyui-validatebox" value="${stockBackPage.stockinno }" data-options=""/>
                    	</td>
					</tr>
                    ...
                    <table border="0" cellpadding="2" cellspacing="0" id="stockinDetail_table">
                        ...
                        <s:iterator value="stockBackDetailList" var="poVal" status="stuts">
	                        <tr >
								  ...
								  <td align="left">
								    <input type="text" name=".articleid" value="${poVal.articleid }" class="easyui-validatebox"  style="width: 50px;" />
								  </td>
								  <td align="left">
								    <input type="text" name=".articlename" value="${poVal.articlepage.articlename }" class="easyui-validatebox"  style="width: 148px;" />
								  </td>
								  <td align="left">
								  ...
								  <td align="left">
								    <input type="text" name=".unitname" value="${poVal.articlepage.unitdic.paramName }" class="easyui-validatebox"  style="width: 40px;" />
								  </td>
								  <td align="left">
								  <input  type="text" name=".serial" value="${poVal.serial }"  class="easyui-validatebox" style="width:70px;" ></td>
								  <td align="left">
								  <input  type="text" name=".expiredate" value="${fn:substring(poVal.expiredate,0,10) }" class="easyui-validatebox" style="width:70px;" >
								  </td>
								  <td align="left">
								   <input type="text" name=".num" value="${poVal.num }" class="easyui-validatebox"  style="width:70px;" >
								   </td>
								  <td align="left">
