...
<script type="text/javascript" src="<%=basePath%>/jslib/jquery-easyui-1.3/jquery.easyui.min.js" charset="utf-8"></script>
<script type="text/javascript" src="<%=basePath%>/jslib/jquery-easyui-1.3/locale/easyui-lang-zh_CN.js" charset="utf-8"></script>
...
<script type="text/javascript" src="<%=basePath%>/jslib/syUtil.js?v=20120805" charset="utf-8"></script>
...
<script type="text/javascript" src="<%=basePath%>/js/py.js" charset="utf-8"></script>
