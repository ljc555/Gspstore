                ...
                <table>
                  <tr bgcolor="#CCE6D1">
					...
					<tr>
                    	...
                    	<td align="left">
                    	<input name="goOrderCode" type="text" class="easyui-validatebox" maxlength="36" value="${gbuyOrderPage.goOrderCode }" data-options="required:true"/>
                    	</td>
                   	 	<td align="left">客户</td>
                    	<td align="left">
                    	<input name="goCusName" type="text" class="easyui-validatebox" maxlength="50" value="${gbuyOrderPage.goCusName }" data-options="required:true"/>
                    	</td>
                   	 	<td align="left">联系人</td>
                    	<td align="left">
                    	<input name="goContactName" type="text" class="easyui-validatebox" maxlength="50" value="${gbuyOrderPage.goContactName }" data-options="required:true"/>
                    	</td>
                   	 	<td align="left">区号</td>
                    	<td align="left">
                    	<input name="goZoneNo" type="text" class="easyui-validatebox" maxlength="6" value="${gbuyOrderPage.goZoneNo }" data-options="required:true"/>
                    	</td>
					</tr>
					<tr>
                   	 	<td align="left">电话</td>
                    	<td align="left">
                    	<input name="goPhone" type="text" class="easyui-validatebox" maxlength="20" value="${gbuyOrderPage.goPhone }" data-options="required:true"/>
                    	</td>
                   	 	<td align="left">手机</td>
                    	<td align="left">
                    	<input name="goTelphone" type="text" class="easyui-validatebox" maxlength="20" value="${gbuyOrderPage.goTelphone }" data-options=""/>
                    	</td>
                   	 	<td align="left">传真</td>
                    	<td align="left">
                    	<input name="goFacsimile" type="text" class="easyui-validatebox" maxlength="32" value="${gbuyOrderPage.goFacsimile }" data-options=""/>
                    	</td>
                   	 	<td align="left">邮箱</td>
                    	<td align="left">
                    	<input name="goMail" type="text" class="easyui-validatebox" maxlength="32" value="${gbuyOrderPage.goMail }" data-options=""/>
                    	</td>
					</tr>
					<tr>
                   	 	<td align="left">订单人数</td>
                    	<td align="left">
                    	<input name="goOrderCount" type="text" class="easyui-numberbox" maxlength="" value="${gbuyOrderPage.goOrderCount }" data-options=""/>
                    	</td>
                   	 	<td align="left">总价(不含返</td>
                    	<td align="left">
                    	<input name="goAllPrice" type="text" class="easyui-numberbox" maxlength="" value="${gbuyOrderPage.goAllPrice }" data-options=""/>
                    	</td>
                   	 	<td align="left">返款</td>
                    	<td align="left">
                    	<input name="goReturnPrice" type="text" class="easyui-numberbox" maxlength="" value="${gbuyOrderPage.goReturnPrice }" data-options=""/>
                    	</td>
                   	 	<td align="left">备注</td>
                    	<td align="left">
                    	<input name="goContent" type="text" class="easyui-validatebox" maxlength="200" value="${gbuyOrderPage.goContent }" data-options=""/>
                    	</td>
					</tr>
					<tr>
                   	 	<td align="left">审核状态 0</td>
                    	<td align="left">
                    	<input name="auditorStatus" type="text" class="easyui-validatebox" maxlength="2" value="${gbuyOrderPage.auditorStatus }" data-options=""/>
                    	</td>
                   	 	<td align="left">审核人ID</td>
                    	<td align="left">
                    	<input name="auditorObid" type="text" class="easyui-validatebox" maxlength="36" value="${gbuyOrderPage.auditorObid }" data-options=""/>
                    	</td>
                   	 	<td align="left">审核人</td>
                    	<td align="left">
                    	<input name="auditorName" type="text" class="easyui-validatebox" maxlength="50" value="${gbuyOrderPage.auditorName }" data-options=""/>
                    	</td>
					</tr>
				 </table>
			    </div>
                        ...
                        <s:iterator value="gbuyOrderCustomList" var="poVal" status="stuts">
	                        <tr>
	                          <td align="center"><input type="checkbox" name="ck"/><input type="hidden" name="gbuyOrderCustomList[${stuts.index }].obid" value="${po.obid }"/></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocCusNameEn" maxlength="50" type="text" value="${poVal.gocCusNameEn }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocCusName" maxlength="50" type="text" value="${poVal.gocCusName }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocCusType" maxlength="3" type="text" value="${poVal.gocCusType }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocSex" maxlength="2" type="text" value="${poVal.gocSex }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocIdcard" maxlength="32" type="text" value="${poVal.gocIdcard }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocBirthday" maxlength="" type="text" value="${poVal.gocBirthday }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocPassportCode" maxlength="32" type="text" value="${poVal.gocPassportCode }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocPassportEndDate" maxlength="" type="text" value="${poVal.gocPassportEndDate }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocBussContent" maxlength="100" type="text" value="${poVal.gocBussContent }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocRoomNum" maxlength="10" type="text" value="${poVal.gocRoomNum }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderCustomList[${stuts.index }].gocContent" maxlength="200" type="text" value="${poVal.gocContent }" class="easyui-validatebox" style="width:120px;" ></td>
	                        </tr>
                        </s:iterator>
                      	</s:if>  
                       </tbody>
                        ...
                        <s:iterator value="gbuyOrderProductList" var="poVal" status="stuts">
	                        <tr>
	                          <td align="center"><input type="checkbox" name="ck"/><input type="hidden" name="gbuyOrderProductList[${stuts.index }].obid" value="${po.obid }"/></td>
								  <td align="left"><input name="gbuyOrderProductList[${stuts.index }].gopProductType" maxlength="3" type="text" value="${poVal.gopProductType }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderProductList[${stuts.index }].gopProductName" maxlength="100" type="text" value="${poVal.gopProductName }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderProductList[${stuts.index }].gopCount" maxlength="" type="text" value="${poVal.gopCount }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderProductList[${stuts.index }].gopUnit" maxlength="2" type="text" value="${poVal.gopUnit }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderProductList[${stuts.index }].gopOnePrice" maxlength="" type="text" value="${poVal.gopOnePrice }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderProductList[${stuts.index }].gopSumPrice" maxlength="" type="text" value="${poVal.gopSumPrice }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderProductList[${stuts.index }].gopContent" maxlength="200" type="text" value="${poVal.gopContent }" class="easyui-validatebox" style="width:120px;" ></td>
								  <td align="left"><input name="gbuyOrderProductList[${stuts.index }].gopProductObid" maxlength="36" type="text" value="${poVal.gopProductObid }" class="easyui-validatebox" style="width:120px;" ></td>
	                        </tr>
                        </s:iterator>
                      	</s:if>  
                       </tbody>
