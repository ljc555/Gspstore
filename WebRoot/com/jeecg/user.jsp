	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			...
			},
			{
				...
				width : 150,
				formatter : function(value, rowData, rowIndex) {
					return sy.fs('<span title="{0}">{1}</span>', rowData.orgName, rowData.orgName);
				},
				editor : {
					type : 'combotree',
					options : {
						url : 'jeecgGroupAction!ctrlTree.action',
						animate : false,
	...
	<div region="north" border="false" title="搜索条件" style="height: 60px;overflow: hidden;" align="left">
		<form id="searchForm">
			<table class="tableForm datagrid-toolbar" style="width: 100%;height: 100%;">
				<tr>
					<td>用户账号</td>
					<td><input name="cname" style="width:120px;" />&nbsp;</td>
					<td>真实名称</td>
					<td><input name="realname" style="width:120px;" /></td>
					<td>所属部门</td>
					<td><select style="width:110px;" class="easyui-combotree" url="jeecgGroupAction!ctrlTree.action" name="org"/></td>
					<td>创建时间</td>
					<td><input name="ccreatedatetimeStart" class="easyui-datetimebox" editable="false" style="width: 117px;" />至<input name="ccreatedatetimeEnd" class="easyui-datetimebox" editable="false" style="width: 117px;" /></td>
