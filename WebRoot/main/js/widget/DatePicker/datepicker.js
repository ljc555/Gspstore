 ...
 */
{
	...
	responseInput: function(date){
		date = [//
					...
					$kit.date.parseDate('2012年4月7日', $kit.date.parseFormat('yyyy年MM月dd日'), 'cn') //
				];
		this.date = date[0];
		this.viewDate = date[0];
		this.selectedDateAry =  date;
		this.update();
		this.show();
	},
	/**
